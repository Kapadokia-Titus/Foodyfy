...
import kapadokia.nyandoro.foodclient.BR;
import kapadokia.nyandoro.foodclient.utils.BigDecimalUtil;
import kapadokia.nyandoro.foodclient.utils.Prices;
...
public class CartViewModel extends BaseObservable {
    ...
    public void setCartVisible(boolean cartVisible) {
        ...
        notifyPropertyChanged(kapadokia.nyandoro.foodclient.BR.cartVisible);
    }

    public void setCart(List<CartItem> cart) {
        Log.d(TAG, "setCart: updating cart ..");
        this.cart = cart;
        notifyPropertyChanged(kapadokia.nyandoro.foodclient.BR.cart);
    }
    ...
    public String getTotalCostString(){
        ...
        //TODO:: change dollar sign to kenyan currency
